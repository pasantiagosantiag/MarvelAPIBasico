...
android {
    namespace = "ies.sequeros.ejemplosktor"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "ies.sequeros.ejemplosktor"
...
compose.desktop {
    application {
        mainClass = "ies.sequeros.ejemplosktor.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "ies.sequeros.ejemplosktor"
